...
mount('#org-ui',
  el('div', { class: 'card card-pad', style: { display: 'grid', gridTemplateColumns: '1fr auto', gap: '12px', alignItems: 'center', color: 'var(--ink)' } }, el('div', {}, el('span', { class: 'eyebrow' }, 'Sarah Miller · your link'), el('div', { style: { fontFamily: 'ui-monospace, Menlo, Consolas, monospace', fontSize: '13px', overflowWrap: 'anywhere' } }, 'ready.harborhomeloans.com/smiller')), el('span', { class: 'btn btn-primary btn-sm' }, 'Text this to a client')),
